...
export default function ProductList() {
  ...
  // Fetch categories and products (publicly)
  ...
  useEffect(() => {
    ...
    const imageChannel = supabase
      .channel('product_images-changes')
      ...
      <div className="px-4 py-8 max-w-7xl mx-auto">
        ...
        <div className="p-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {filteredProducts.map((product) => {
            ...
            const imageUrl = `${primaryImage}?t=${Date.now()}`; // force reload
              ...
              <Link key={product.id} href={`/products/${product.id}`}>
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-gray-500 text-sm mt-1">{product.description?.slice(0, 60)}</p>
